...
# Run the application
dotnet run --project src/MinimalTips.Website3.Web

# Or run with Aspire (if using)
dotnet run --project src/MinimalTips.Website3.AspireHost
```
...
```powershell
dotnet ef database update -c AppDbContext -p src/MinimalTips.Website3.Web -s src/MinimalTips.Website3.Web
dotnet run --project src/MinimalTips.Website3.Web
```
