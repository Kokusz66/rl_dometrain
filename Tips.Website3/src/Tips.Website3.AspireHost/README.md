...
1. Set `Tips.Website3.AspireHost` as the startup project
...
```bash
dotnet ef migrations add MigrationName -c AppDbContext -p ../Tips.Website3.Infrastructure/Tips.Website3.Infrastructure.csproj -s Tips.Website3.Web.csproj -o Data/Migrations
```

To update the database:
```bash
dotnet ef database update -c AppDbContext -p ../Tips.Website3.Infrastructure/Tips.Website3.Infrastructure.csproj -s Tips.Website3.Web.csproj
```
