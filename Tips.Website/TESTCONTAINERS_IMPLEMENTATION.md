...
**Updated `tests\Tips.Website.FunctionalTests\Tips.Website.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\Tips.Website.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\Tips.Website.FunctionalTests\Tips.Website.FunctionalTests.csproj
```
