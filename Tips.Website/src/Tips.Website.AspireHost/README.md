...
1. Set `Tips.Website.AspireHost` as the startup project
...
```bash
dotnet ef migrations add MigrationName -c AppDbContext -p ../Tips.Website.Infrastructure/Tips.Website.Infrastructure.csproj -s Tips.Website.Web.csproj -o Data/Migrations
```

To update the database:
```bash
dotnet ef database update -c AppDbContext -p ../Tips.Website.Infrastructure/Tips.Website.Infrastructure.csproj -s Tips.Website.Web.csproj
```
